...
OUT_GTK2?=ddb_vis_musical_spectrum_GTK2.so
OUT_GTK3?=ddb_vis_musical_spectrum_GTK3.so
...
CC?=clang
CFLAGS+=-Wall -g -O2 -fPIC -std=c99 -D_GNU_SOURCE -Wno-deprecated-declarations
LDFLAGS+=-shared
